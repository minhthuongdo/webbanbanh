...
<php lang="vi">
    ...
    <body>
      <div class="container">
        ...
        <main>
          <div class="allorders">
            <h2>Tất cả hóa đơn của sản phẩm: CC02 (Cupcake Redvelvet)</h2>
            <table>
              <thead>
                <tr>
                  <th>Mã hóa đơn</th>
              ...
              <tbody>
                <tr>
                    ...
                    <td>110.000đ</td>
                    <td><a href="hoadoncc02/hoadon01.php" target="_blank"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
                <tr>
                    <td>HD126</td>
                    <td>03/12/2024</td>
                    <td>CC02, BK02</td>
                    <td>300.000đ</td>
                    <td><a href="hoadoncc02/hoadon02.php" target="_blank"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
                <tr>
                    <td>HD114</td>
                    <td>02/12/2024</td>
                    <td>CC02, CC03</td>
                    <td>80.000đ</td>
                    <td><a href="hoadoncc02/hoadon03.php" target="_blank"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
                <tr>
                    <td>HD102</td>
                    <td>02/12/2024</td>
                    <td>BK05, CC02</td>
                    <td>300.000đ</td>
                    <td><a href="hoadoncc02/hoadon04.php" target="_blank"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
                <tr>
                    <td>HD092</td>
                    <td>01/12/2024</td>
                    <td>CC05, CC02</td>
                    <td>80.000đ</td>
                    <td><a href="hoadoncc02/hoadon05.php" target="_blank"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
              </tbody>
            </table>
