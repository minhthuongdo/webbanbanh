    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Cookies </span>Dâu Sprinkle</h1>
                   <p>Thành phần: </p>
                  <p> Bột mì, bơ, đường bột, trứng, sữa, vani, màu thực phẩm hồng, sprinkles,... </p>
                   <p>Cách bảo quản: </p>
                   <p>Nên bảo quản bánh ở nhiệt độ phòng, khoảng 20-25°C.
                   Nhiệt độ quá cao có thể làm bánh bị mềm, trở nên dính dính.
