    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Bánh kem </span>Xoài</h1>
                    <p>Nguyên liệu: bột mì, trứng, đường, sữa tươi, dầu thực vật, bơ chảy, kem, xoài,...</p>
                    <p>Bảo quản: dùng ngay khi mở, có thể bảo quản trong ngăn mát</p>
                ...
                <a class="btn" href="javascript:void(0);" onclick="handleAddToCart(2)">Thêm vào giỏi hàng</a>
                </div>
        </div>
    </section>
    <!--footer begins-->
