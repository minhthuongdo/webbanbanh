...
<body>
    <header class="header">
        ...
        <nav class="navbar">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              <a href="../Sp/Cookies.php
              ">Cookie</a>
              <a href="../Sp/Donut.php
              ">Donut</a>
              <a href="../Sp/Cupcake.php
              ">Cupcake</a>
              <a href="../Sp/Bento.php
              ">Bánh kem</a>
              <a href="../Sp/SuKem.php
        ...
        <div class="icons">
            ...
            " class="user-icon"><i class="fa-solid fa-user"></i></a>
        ...
        <div class="user-form">
            <a class="chs" href="../User/login.php
            ">Đăng nhập</a><a class="chs" href="../User/signup.php
            ">Đăng ký</a>
        </div>
    </header>
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Bánh kem </span> Chocolate Dâu Tây</h1>
                   <p>Thành phần: </p>
                   <p>bột mì, trứng, đường, bơ, kem tươi, vani, sốt socola, dâu tây,...</p>
                   <p>Cách bảo quản</p>
                   <p>Bảo quản ở nhiệt độ thấp, khoảng 5-10°C để bánh và dâu tây giữ được độ tươi ngon.
                   Bánh có thể được bảo quản trong tủ lạnh khoảng 3-5 ngày.
