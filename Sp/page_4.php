        ...
        <section class="cakes" id="cakes">
            ...
            <div class="wrapper" id="cake-list">
                ...
                <div class="cake-card">
                    ...
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(23)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/banhquy_5.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
            ...
            <div class="pagination">
                ...
                <a href="../Sp/page_4.php" class="active">4</a>
