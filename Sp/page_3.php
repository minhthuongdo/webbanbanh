    ...
    <body>
        ...
        <section class="cakes" id="cakes">
            ...
            <div class="wrapper" id="cake-list">
                <div class="cake-card">
                    <img src="../Images/cupcake_3.jpg" alt="" />
                    <h3> Cupcake Anh Đào</h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(13)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/cupcake_3.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    ...
                    <a class="btn" href="../Sp/banhquy_2.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    ...
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(15)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/banhquy_1.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    ...
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(16)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/banhquy_3.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    ...
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(17)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/banhquy_4.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/banhxukem_1.jpg" alt="" />
                    <h3>Bánh Su Kem Chiên Giòn</h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(18)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/xukem_1.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/banhxukem_3.jpg" alt="" />
                    <h3>Bánh Su Kem Sốt Chocolate</h3>
                    <div class="price">25.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(19)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/xukem_3.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    ...
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(20)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/xukem_4.php">
                        Xem thông tin
                   </a>
                </div>
            </div>
            <div class="pagination">
                ...
                <a href="../Sp/page_2.php">2</a>
                <a href="../Sp/page_3.php" class="active">3</a>
                <a href="../Sp/page_4.php">4</a>
                <a href="../Sp/page_4.php">></a>
            </div>
        </section>
