...
<body>
    <header class="header">
        ...
        <nav class="navbar">
          <a href="../User/User.php">TRRANG CHỦ</a>
          <div class="dropdown">
    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Cupcake </span>Vani Chocolate</h1>
                  <p> Thành phần
                    Bột mì, bơ, đường, trứng, sữa, vani, socola chip,... </p>
                   <p> Cách bảo quản
                    Lý tưởng nhất là bảo quản bánh ở nhiệt độ lạnh, khoảng 15-20°C. Bảo quản tối đa 3-4 ngày ở tủ lạnh
                    Nhiệt độ quá cao có thể làm bánh bị khô, lớp kem sẽ dễ tan chảy.</p>
