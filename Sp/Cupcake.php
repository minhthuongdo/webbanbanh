    ...
    <body>
        <header class="header">
            ...
            <nav class="navbar">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-content">
                  ...
                  <a href="../Sp/Donut.php">Cupcake</a>
                  <a href="../Sp/Donut.php">Bánh kem</a>
            ...
            <div class="icons">
                ...
                <div class="user-icon" href="../User/profile.php"><i class="fa-solid fa-user"></i></div>
            ...
            <div id="cart" class="cart-modal">
                <div class="cart-content">
                    <button class="close-btn" onclick="toggleCartVisibility()">X</button>
                    <h2>Giỏ Hàng</h2>
                    <ul id="cart-items"></ul>
                    <div class="cart-footer">
                        <p>Total: <span id="cart-total">0</span> VND</p>
        ...
        <section class="cakes" id="cakes">
            <h3 class="title"> Bánh<span> cupcake</span></h3>
            <div class="wrapper" id="cake-list">
                ...
                <div class="cake-card">
                    <img src="../Images/cupcake_4.jfif" alt="" />
                    <h3> Cupcake Mâm Xôi</h3>
                    <div class="price">25.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(22)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/cupcake_4.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/cupcake_5.jfif" alt="" />
                    <h3> Cupcake Caramel</h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(21)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/cupcake_5.php">
                        Xem thông tin
                   </a>
                </div>
            </div>
            ...
            <div class="pagination">
                <a href="../Sp/Cupcake.php"><</a>
                <a href="../Sp/Cupcake.php" class="active">1</a>
                <a href="../Sp/Cupcake.php">></a>
            </div>
        </section>
