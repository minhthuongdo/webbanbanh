    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Bánh Su Kem </span>Socola Vỏ Giòn </h1>
                   <p>Nguyên liệu: </p>
                  <p> Bột gạo, bột mì, bơ, đường, trứng, sữa, kem tươi, vani, socola</p>
                   <p>Cách bảo quản: <p>
                ...
                <a class="btn" href="javascript:void(0);" onclick="handleAddToCart(20)">Add to cart</a>
                </div>
        </div>
    </section>
    <!--footer begins-->
