    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Bánh Su Kem </span>  Sốt Socola</h1>
                  <p> Thành phần: </p>
                   <p>Bột mì, bơ, đường, trứng, sữa, kem tươi, vani, sốt socola </p>
                  <p> Cách bảo quản: </p>
                  <p> Bảo quản bánh ở nhiệt độ khoảng 15-20°C.
                   Bánh su kem có thể được bảo quản trong tủ lạnh khoảng 3-5 ngày.
               ...
               <a class="btn" href="javascript:void(0);" onclick="handleAddToCart(19)">Add to cart</a>
               </div>
        </div>
    </section>
    <!--footer begins-->
