...
<php lang="en">
    ...
    <body>
        ...
        <section class="cakes" id="cakes">
            <h3 class="title"> Bánh<span> xu kem</span></h3>
            <div class="wrapper" id="cake-list">
                ...
                <div class="cake-card">
                    ...
                    <h3>Bánh Su Sem Socola Vỏ Giòn </h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="jjavascript:void(0);" onclick="handleAddToCart(20)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/xukem_4.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/banhxukem_5.jpg" alt="" />
                    <h3>Bánh Su Kem Dẻo </h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(24)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/xukem_5.php">
                        Xem thông tin
                   </a>
                </div>
            </div>
            ...
            <div class="pagination">
                <a href="../Sp/SuKem.php"><</a>
                <a href="../Sp/SuKem.php" class="active">1</a>
                <a href="../Sp/SuKem.php">></a>
            </div>
        </section>
