    ...
    <body>
            ...
            <div id="cart" class="cart-modal">
                <div class="cart-content">
                    ...
                    <div class="cart-footer">
                        <p>Tổng tiền: <span id="cart-total">0</span> VND</p>
                        <a class="btn" href="../User/ThongTin.php">
                            Thanh toán
                       </a>
                    </div>
                </div>
        ...
        <section class="cakes" id="cakes">
            ...
            <div class="wrapper" id="cake-list">
                <div class="cake-card">
                    <img src="../Images/bento_5.jfif" alt="" />
                    <h3>Bánh Kem Tiramisu</h3>
                    <div class="price">270.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(5)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/bento_5.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/donut_1.jfif" alt="" />
                    <h3>Donut Hạnh Nhân</h3>
                    <div class="price">25.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(6)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/Donut_1.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/donut_2.jpg" alt="" />
                    <h3>Donut Caramel</h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(7)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/donut_2.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/donut_3.jpg" alt="" />
                    <h3>Donut Halloween</h3>
                    <div class="price">25.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(8)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/donut_3.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/donut_4.jpg" alt="" />
                    <h3>Donut Chocolate Sprinkle</h3>
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(9)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/donut_4.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/donut_5.jpg" alt="" />
                    <h3> Donut Matcha Chocolate</h3>
                    <div class="price">30.000</span></div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(10)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/donut_5.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    <img src="../Images/cupcake_1.jpg" alt="" />
                    <h3> Cupcake Vani Chocolate</h3>
                    <div class="price">25.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(11)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/cupcake_1.php">
                        Xem thông tin
                   </a>
                </div>
                <div class="cake-card">
                    ...
                    <div class="price">30.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(12)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/cupcake_2.php">
                        Xem thông tin
                   </a>
                </div>
            </div>
            <div class="pagination">
                <a href="../User/User.php"><</a>
                <a href="../User/User.php">1</a>
                <a href="../Sp/page_2.php" class="active">2</a>
                <a href="../Sp/page_3.php">3</a>
                <a href="../Sp/page_4.php">4</a>
                <a href="../Sp/page_3.php">></a>
            </div>
        </section>
