...
<html lang="en">
    ...
    <body>
        <header class="header">
            ...
            <nav class="navbar">
              <a href="..//User/User.html">TRANG CHỦ</a>
              <div class="dropdown">
                <button class="dropbtn" onclick="toggleDropdown(event)">SẢN PHẨM</button>
                <div class="dropdown-content">
                  <a href="../Sp/Cookies.html">Cookie</a>
                  <a href="../Sp/Donut.html">Donut</a>
                  <a href="../Sp/Cupcake.html">Cupcake</a>
                  <a href="../Sp/Bento.html">Bánh kem</a>
                  <a href="../Sp/SuKem.html">Su kem</a>
                </div>
              </div>
              <a href="../Sp/bestseller.html">BÁN CHẠY</a>
            ...
            <div class="icons">
                ...
                <a href="../User/profile.html" class="user-icon"><i class="fa-solid fa-user"></i></a>
            ...
            <div id="cart" class="cart-modal">
                <div class="cart-content">
                    ...
                    <div class="cart-footer">
                        ...
                        <a class="btn" href="../User/ThongTin.html">
                            Thanh toán
                       </a>
                    </div>
                </div>
            ...
            <div class="user-form">
                <a class="chs" href="../User/login.html">Đăng nhập</a><a class="chs" href="../User/signup.html">Đăng ký</a>
            </div>
        ...
        <section class="cakes" id="cakes">
            <h3 class="title"> Bánh<span> Kem</span></h3>
            <div class="wrapper" id="cake-list">
                <div class="cake-card">
                    <img src="../Images/bento_2.jpg" alt="" />
                    <h3>Bánh Kem Xoài</h3>
                    <div class="price">250.000</div>
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(2)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/bento_2.html">
                        Xem thông tin
                   </a>
                </div>
                ...
                <div class="cake-card">
                    ...
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(3)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/bento_3.html">
                        Xem thông tin
                   </a>
                </div>
                ...
                <div class="cake-card">
                    ...
                    <a class="btn " href="javascript:void(0);" onclick="handleAddToCart(4)" >Thêm vào giỏ hàng</a>
                    <a class="btn" href="../Sp/bento_4.html">
                        Xem thông tin
                   </a>
                </div>
                ...
                <div class="cake-card">
                    ...
                    <a class="btn" href="../Sp/bento_5.html">
                        Xem thông tin
                   </a>
                </div>

                <div class="pagination">
                    <a href="../Sp/Bento.html"><</a>
                    <a href="../Sp/Bento.html" class="active">1</a>
                    <a href="../Sp/Bento.html">></a>
                </div>
            </div>
