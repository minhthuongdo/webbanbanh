    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Bánh Su Kem </span> Chiên Giòn</h1>
                   <p>Thành phần: </p>
                  <p> Bột mì, bột chiên giòn, bơ, trứng, sữa, đường, vani</p>
                  <p> Cách bảo quản: </p>
                  <p> Bảo quản bánh ở nhiệt độ phòng, khoảng 20-25°C.
                   Nhiệt độ quá cao có thể làm bánh bị cháy hoặc bị mềm, nát.
                   Bảo quản trong 2-3 ngày ở nhiệt độ phòng.
                   Nên sử dụng bánh trong thời gian sớm nhất để đảm bảo chất lượng tốt nhất, không bị mất độ giòn.</p>
               ...
               <a class="btn" href="javascript:void(0);" onclick="handleAddToCart(18)">Add to cart</a>
               </div>
        </div>
    </section>
    <!--footer begins-->
