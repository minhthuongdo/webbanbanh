    ...
    <section class="form" id="about-us">
        <div class="container">
            <div class="img" id="banhxukem">
                ...
                <div class="content">
                   <h1 class="title"><span>Bánh Su Kem </span>Dẻo </h1>
                  <p> Nguyên liệu: </p>
                   <p>Bột mì, bơ, đường, trứng, sữa, socola, kem tươi, vani, hạnh nhân, sốt trái cây</p>
                   <p>Cách bảo quản: </p>
                   <p>Bảo quản bánh ở nhiệt độ tủ lạnh, khoảng 20-25°C.
                   Bảo quản trong 2-3 ngày ở nhiệt độ tủ lạnh.
                ...
                <a class="btn" href="javascript:void(0);" onclick="handleAddToCart(24)">Add to cart</a>
                </div>
        </div>
    </section>
    <!--footer begins-->
