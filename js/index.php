...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            <nav class="navbar">
              <a href="../B09/index.html">TRANG CHỦ</a>
              <div class="dropdown">
                <button class="dropbtn" onclick="toggleDropdown(event)">SẢN PHẨM</button>
                <div class="dropdown-content">
                  <a href="../B09/Sp/Cookies_index.html">Cookie</a>
                  <a href="../B09/Sp/Donut_index.html">Donut</a>
                  <a href="../B09/Sp/Cupcake_index.html">Cupcake</a>
                  <a href="../B09/Sp/Bento_index.html">Bánh kem</a>
                  <a href="../B09/Sp/SuKem_index.html">Su kem</a>
                </div>
              </div>
              <a href="../B09/Sp/bestseller_index.html">BÁN CHẠY</a>
            ...
            <div class="user-form">
                <a class="chs" href="../B09/User/login.html">Đăng nhập</a><a class="chs" href="../B09/User/signup.html">Đăng ký</a>
            </div>
        </header>
                    ...
                    <div class="wrapper">
                        <div class="bestseller-card">
                            ...
                            <div class="stars">
                                ...
                                <a class="btn" href="../B09/Sp/bento_1.html">
                                    Xem thông tin
                               </a>
                        </div>
                        </div>
        ...
        <div class="bestseller-card">
            ...
            <div class="stars">
                ...
                <a class="btn " href="#" onclick="handleCartClick(event)">Thêm vào giỏ hàng</a>
                <a class="btn" href="../B09/Sp/xukem_4.html">
                    Xem thông tin
               </a>
        </div>
        </div>
                        ...
                        <div class="bestseller-card">
                            ...
                            <div class="stars">
                                ...
                                <a class="btn " href="#" onclick="handleCartClick(event)">Thêm vào giỏ hàng</a>
                                <a class="btn" href="../B09/Sp/cupcake_2.html">
                                    Xem thông tin
                               </a>
                        ...
                        <div class="bestseller-card" id="product-image">
                            ...
                            <div class="stars">
                                ...
                                <a class="btn " href="#" onclick="handleCartClick(event)">Thêm vào giỏ hàng</a>
                                <a class="btn" href="../B09/Sp/donut_3.html">
                                     Xem thông tin
                                </a>
                        </div>
        ...
        <section class="cakes" id="cakes">
            ...
            <div class="wrapper" id="cake-list">
                ...
                <div class="cake-card">
                    ...
                    <div class="price">250.000</div>
                    <a class="btn " href="#" onclick="handleCartClick(event)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../B09/Sp/bento_2.html">
                        Xem thông tin
                   </a>
                </div>
                ...
                <div class="cake-card">
                    ...
                    <a class="btn " href="#" onclick="handleCartClick(event)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../B09/Sp/bento_3.html">
                        Xem thông tin
                   </a>
                </div>
                ...
                <div class="cake-card">
                    ...
                    <a class="btn " href="#" onclick="handleCartClick(event)">Thêm vào giỏ hàng</a>
                    <a class="btn" href="../B09/Sp/bento_4.html">
                        Xem thông tin
                   </a>
                </div>
            </div>
            <div class="pagination">
                <a href="../B09/index.html"><</a>
                <a href="../B09/index.html" class="active">1</a>
                <a href="../B09/Sp/page_2_index.html">2</a>
                <a href="../B09/Sp/page_3_index.html">3</a>
                <a href="../B09/Sp/page_4_index.html">4</a>
                <a href="../B09/Sp/page_2_index.html">></a>
            </div>
        </section>
        ...
        <div class="notification">
          <div class="content">
            ...
            <button onclick="location.href='../B09/User/signup.html'">Đăng ký</button>
            <button onclick="location.href='../B09/User/login.html'">Đăng nhập</button>
          </div>
        </div>
