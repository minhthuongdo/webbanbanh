...
function handleSearch(event) {
  ...
  if (searchQuery === "cupcake") {
    window.location.href = "../Sp/Cupcake_index.html"; // Chuyển hướng đến cupcake.html
} else if (searchQuery === "cookie") {
    window.location.href = "../Sp/Cookies_index.html"; // Chuyển hướng đến cookie.html
} else if (searchQuery === "bánh kem") {
    window.location.href = "../Sp/Bento_index.html"; // Chuyển hướng đến bento.html
} else if (searchQuery === "bánh su kem") {
    window.location.href = "../Sp/SuKem_index.html"; // Chuyển hướng đến sukem.html
} else if (searchQuery === "donut") {
    window.location.href = "../Sp/Donut_index.html"; // Chuyển hướng đến donut.html
} else {
    // Danh sách các URL ngẫu nhiên
  const randomPages = [
    "../Sp/Cupcake_index.html",
    "../Sp/Cookies_index.html",
    "../Sp/Bento_index.html",
    "../Sp/SuKem_index.html",
    "../Sp/Donut_index.html",
